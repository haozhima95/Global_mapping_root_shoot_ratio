...
modelprediction<-read.csv('C:\\Users\\haozh\\Desktop\\root_ratio\\grsearch\\forest_250km.csv')
...
modelprediction[modelprediction$dens >148, 'colors'] = '#BEBEBE'
...
Dens2D = ggplot(modelprediction, aes(x=predictmean, y=regressionmatrix.rmf) ) +
  stat_density_2d(aes(fill = ..level..), geom = "polygon") +
  scale_fill_distiller(limits = c(0,0.025),palette=4, direction=-1) +
...
modelprediction<-read.csv('C:\\Users\\haozh\\Desktop\\root_ratio\\grsearch\\grass_500km.csv')
#summary(modelprediction$regressionmatrix.rmf)
head(modelprediction)
paletteForUse <- c('#FF0000',"#FDE725", "#AADC32", "#5DC863", "#27AD81", "#21908C", "#2C728E", "#3B528B", "#472D7B", "#440154")
colors <-  colorRampPalette(paletteForUse)(256)
...
Dens2Dgrass = ggplot(modelprediction, aes(x=predictmean, y=regressionmatrix.rmf) ) +
  stat_density_2d(aes(fill = ..level..), geom = "polygon") +
...
modelprediction<-read.csv('C:\\Users\\haozh\\Desktop\\root_ratio\\grsearch\\shrub_250km.csv')
...
Dens2Dshrub = ggplot(modelprediction, aes(x=predictmean, y=regressionmatrix.rmf) ) +
  stat_density_2d(aes(fill = ..level..), geom = "polygon") +
  scale_fill_distiller(palette=4, direction=1) +
  #geom_hline(aes(yintercept=4.7))+
  #coord_cartesian(ylim = c(0, 10),xlim = c(-4, 19))+
...
st <- 'C:\\Users\\haozh\\Desktop\\root_ratio\\model_biome_comparison\\20200805\\'
...
Load the dataset
```{R}
forestcvprediction<-read.csv('C:\\Users\\haozh\\Desktop\\root_ratio\\grsearch\\forest_250km.csv')

grasscvprediction<-read.csv('C:\\Users\\haozh\\Desktop\\root_ratio\\grsearch\\grass_500km.csv')

shrubcvprediction<-read.csv('C:\\Users\\haozh\\Desktop\\root_ratio\\grsearch\\shrub_250km.csv')
...
```{R}
spatial.cv <- read.csv('C:\\Users\\haozh\\Desktop\\root_ratio\\spatial_cv\\spatial_cv_result.csv')
...
modelprediction<-read.csv('C:\\Users\\haozh\\Desktop\\root_ratio\\grsearch\\forest_cvprediction_20200821.csv')
head(modelprediction)
#summary(modelprediction$regressionmatrix.rmf)
paletteForUse <- c('#FF0000',"#FDE725", "#AADC32", "#5DC863", "#27AD81", "#21908C", "#2C728E", "#3B528B", "#472D7B", "#440154")
colors <-  colorRampPalette(paletteForUse)(256)
...
modelprediction<-read.csv('C:\\Users\\haozh\\Desktop\\root_ratio\\grsearch\\grass_cvprediction_20200821.csv')
#summary(modelprediction$regressionmatrix.rmf)
head(modelprediction)
paletteForUse <- c('#FF0000',"#FDE725", "#AADC32", "#5DC863", "#27AD81", "#21908C", "#2C728E", "#3B528B", "#472D7B", "#440154")
colors <-  colorRampPalette(paletteForUse)(256)
...
modelprediction<-read.csv('C:\\Users\\haozh\\Desktop\\root_ratio\\grsearch\\shrub_cvprediction_20200821.csv')
#summary(modelprediction$rmf)
paletteForUse <- c('#FF0000',"#FDE725", "#AADC32", "#5DC863", "#27AD81", "#21908C", "#2C728E", "#3B528B", "#472D7B", "#440154")
colors <-  colorRampPalette(paletteForUse)(256)
