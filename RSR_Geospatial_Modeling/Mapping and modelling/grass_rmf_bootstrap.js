// This script is used for bootstrapping the grass rmfs for evaluating model uncertainties. Contributed by Johan van den Hoogen.
...
var comp = ee.Image("users/haozhima95/Devin_environment_composite_20190218"),
    ...
    image = ee.Image("users/haozhima95/consensus_full_class_grass");
    


// Import the features
var grass_collection = ee.FeatureCollection("your directory/grass_rsr_sample_for_grsearch_20200517");
...
var covarsToUse_Current = grass_collection.first().propertyNames().removeAll([
  'system:index',
	'index',
	'ratio',
	'Pixel_Long',
...
var orig_prediction = ee.Image('users/haozhima95/rootshootratio/grass_rmf_model_aggregate_first_1_20200517')
...
Export.table.toAsset({
	...
	description: 'rmf_grass_sampled_points',
	assetId: 'users/johanvandenhoogen/2021_rmf_rerun/rmf_grass_sampled_points_wBiome'
});

// var sampled_points = ee.FeatureCollection('users/johanvandenhoogen/2021_rmf_rerun/rmf_grass_sampled_points_wBiome')//.set('band_order', covarsToUse_Current)
...
var bootstrapFileName = 'grass_rmf_Bootstrap_';
...
seedsForBootstrapping.map(function(seedToUse) {
	...
	Export.image.toAsset({
		...
		assetId: 'projects/crowtherlab/johan/2021_rmf_rerun/grass_bootstrapColls/' + bootstrapFileName + pad(seedToUse,2),
		region: unboundedGeo,
		crs: 'EPSG:4326',
...
var bootstrapIterations = ee.ImageCollection('projects/crowtherlab/johan/2021_rmf_rerun/grass_bootstrapColls')
...
Export.image.toAsset({
	...
	description: 'rmf_grass_bootstrapped_images',
	assetId: 'users/johanvandenhoogen/2021_rmf_rerun/grass_rmf_Bootstrapped_MultibandImage',
	region: unboundedGeo,
	crs: 'EPSG:4326',
	crsTransform: [0.008333333333333333, 0, -180, 0, -0.008333333333333333, 90],
	maxPixels: 1e13
